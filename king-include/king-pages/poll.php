...
$poll   = '<div class="king-ang">
	...
	<div class="inputArea">
		<div ui-sortable="sortableOptions2" ng-model="inputs" class="king-poll-grids {{polltab}}">
			<div ng-repeat="input in inputs | limitTo:24" class="king-poll-grid">
				...
				<input class="hide" type="text" ng-model="input.img" ng-show="polltab !== \'grid1\'" class="" name="out[{{$index+1}}][img]" autocomplete="off" maxlength="40"/>
				<input class="hide" type="text" ng-model="input.id" name="out[{{$index+1}}][id]" ng-value="{{::$id}}"  maxlength="15"/>
				<input class="king-form-tall-text" type="text" ng-model="input.choices" name="out[{{$index+1}}][choices]" required autocomplete="off" maxlength="250"/>
				<div class="inleft">
