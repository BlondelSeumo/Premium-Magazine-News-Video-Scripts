...
if (qa_clicked('doask')) {
    ...
    if (!qa_check_form_security_code('ask', qa_post_text('code'))) {
        ...
        if (empty($errors)) {
            ...
            if ($type == "vimeo.com" || $type == "dailymotion.com" || $type == "metacafe.com" || $type == "vine.co" || $type == "instagram.com" || $type == "vid.me" || $type == "drive.google.com" || $type == "open.spotify.com" || $type == "twitter.com") {
                ...
                $thumb2 = king_soundcloud($videocontent);
            } elseif ($type == "vk.com") {
...
if (qa_opt('links_in_new_window')) {
    ...
    $vidupload .= '<div id="vidurl" role="tabpanel" class="tabcontent active">
                    ...
                    <input placeholder="'.qa_lang_html('misc/video_url').'" name="extra" value="' . qa_html(@$in['extra']) . '"  id="content2" autocomplete="off" type="text" class="king-form-tall-text" onchange="video_add(this.value)" onInput="video_add(this.value)">
...
$qa_content['form'] = array(
    ...
    'fields'  => array(
        ...
        'pcontent' => array(
            ...
            'type'  => 'custom',
            'html'  => '<div id="pcontent">' . qa_html(@$in['pcontent']) . '</div>',
