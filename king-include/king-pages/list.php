...
$poll   = '<div class="king-ang">
	<div class="inputArea">
		<div ui-sortable="sortableOptions" ng-model="inputs" class="king-lists">
				...
				<div class="inright">
					<input class="king-form-tall-text" type="text" ng-model="input.choices" name="out[{{$index+1}}][choices]" required autocomplete="off" maxlength="200"/>
						...
						<div ng-show="input.tabz == \'grid2\'">
							<input class="king-form-tall-text" type="text" ng-model="input.video" name="out[{{$index+1}}][video]" autocomplete="off" maxlength="250" placeholder="'.qa_lang_html('misc/video_url').'"/>
						</div>
					
					<input class="hide" type="text"  name="out[{{$index+1}}][id]" value="{{$index+1}}"/>
					<textarea class="king-form-tall-text" type="textarea"  name="out[{{$index+1}}][desc]" maxlength="400"></textarea>
				</div>
				<div class="inleft">
